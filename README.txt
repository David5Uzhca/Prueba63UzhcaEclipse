...
a persistence unit "prueba63UzhcaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "prueba63Uzhca/pom.xml":
...
artifact ("prueba63Uzhca.war") is already built. You can build
